    ...
    <div className="w-[220px] lg:w-[280px] bg-[#EBEFF3] hidden md:block rounded-[8px] p-[18px]">
        ...
        <div className='mb-[33px]'>
            ...
            <div className="flex flex-wrap gap-[5px]">
                ...
                <button onClick={() => handleChangeBrand("3")} className={`text-[12px] font-[400] leading-[16px] py-[7px] transition-all duration-400 hover:bg-[#134E9B] hover:text-[#fff] cursor-pointer px-[18px] rounded-[20px] ${brandParams == '3' ? "bg-[#134E9B] text-[#fff]" : " bg-[#fff] text-[#0A1729]"}`}>Nokia</button>
                <button onClick={() => handleChangeBrand("5")} className={`text-[12px] font-[400] leading-[16px] py-[7px] transition-all duration-400 hover:bg-[#134E9B] hover:text-[#fff] cursor-pointer px-[18px] rounded-[20px] ${brandParams == '5' ? "bg-[#134E9B] text-[#fff]" : " bg-[#fff] text-[#0A1729]"}`}>Apple</button>
