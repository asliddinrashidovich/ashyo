    ...
    <div className="max-w-[1200px] mx-auto flex py-[40px] gap-[30px] px-[20px]">
        <div className="md:block hidden w-[25%] p-[18px]">
            ...
            <div>
                ...
                <div onClick={() => handleTab('Track Order')} className={`flex gap-[11px] items-center border-l-[5px] pl-[20px] cursor-pointer ${activeFilter == 'track-order' ? 'border-[#134e9b]' : 'border-[#fff]'}`}> 
                    <IoMdSpeedometer style={{color: '#727272'}}/>
                    <p className={`font-[700] text-[15px] leading-[45px] ${activeFilter == 'track-order' ? 'text-[#134e9b]' : 'text-[#727272]'}`}>Track Order</p>
                </div>
            </div>
