        ...
        <Swiper pagination={true} modules={[Pagination]} className="h-full mySwiper flex justify-between ">
          {sliderData.map((item: sliderDataType) => (
            <SwiperSlide key={item.id} >
              <div className='main-container flex justify-between items-center relative h-[350px] md:h-full px-5 md:px-10'>
                <div className='absolute w-[300px] md:w-[400px] lg:w-[700px] left-[20px] md:left-[40px] z-5'>
                ...
                <div className='absolute top-0 bottom-0 w-[600px] right-[-90px] md:right-[0]'> 
