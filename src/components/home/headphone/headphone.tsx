function HeadphoneSection() {
  return (
    <section className=" px-5 md:px-10 pt-[20px] pb-[170px]">
        <div className="h-[420px]  rounded-[10px] bg-[#282828] max-w-[1185px] mx-auto grid grid-cols-2 items-center gap-[20px]">
            ...
            <div className="max-w-[450px] pl-[40px]">
                ...
                <button className="py-[18px] px-[16px] font-[400] leading-[120%] text-[16px] rounded-[6px] cursor-pointer bg-[#FFFFFF] w-[160px]">Batafsil</button>
            </div>
        </div>
    </section>
  )
